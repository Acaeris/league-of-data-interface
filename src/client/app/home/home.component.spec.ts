      ...
      async(() => {
        TestBed
          ...
          .then(() => {
            ...
            expect(homeDOMEl.querySelectorAll('.list .item').length).toEqual(3);
            ...
            expect(homeDOMEl.querySelectorAll('.list .item').length).toEqual(4);
            expect(homeDOMEl.querySelectorAll('.list .item .content')[3].textContent).toEqual('Minko');
          });
